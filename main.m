...
global valuesSensors;
    ...
    img = imread('elisa3.1-top-all-small.jpg');
...
% Update odometry -----------------------------------------
%ePic = updateOdometry(ePic);   // already done in update
[val, up] = get(ePic,'odom');
if (up > 0)
    %set(handles_save.txt_odoX,'String',num2str(100 * val(1)));
    %set(handles_save.txt_odoY,'String',num2str(100 * val(2)));
    set(handles_save.txt_odoX,'String',num2str(val(1)));
    set(handles_save.txt_odoY,'String',num2str(val(2)));
